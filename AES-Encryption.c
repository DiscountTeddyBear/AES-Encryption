...
int main(int argc, char *argv[]){
    ...
    char *help_message = "\nUsage: ./AESencryption [encrypt/decrypt] [cypher_key](Optional if encrypting)"
    ...
    char encryptOrDecrypt[100]; //Stores whether the user wants to encrypt or decrypt the file
    strcpy(encryptOrDecrypt, argv[1]);
    ...
    if(argc == 4 && strcmp(encryptOrDecrypt, "encrypt") == 0){
        Nk = 8;
        Nr = 14;
    ...
    else if(argc == 4 && strcmp(encryptOrDecrypt, "decrypt") == 0){
